...
var proxy = function (propertyName, target, propConfig) {
    if (!("data" in propConfig) && !("factory" in propConfig) || !(propertyName in target.prototype)) {
        return;
    }
    ...
    return Object.defineProperty(target.prototype, propertyName, {
        ...
        get: function () {
            ...
            paramsInstance = paramsInstance || (Array.isArray(inject) ? inject : []).map(function (sender) { return Injector_1.Factory.createConstructor(sender); });
...
exports.initProperty = function (target) {
    ...
    propertyParams.forEach(function (propertyConfig) { return proxy(propertyConfig.propertyName || "", target, propertyConfig); });
};
